...
time.sleep(20)
driver.find_element(By.XPATH, '//*[@id="signup-username"]').send_keys("".join(random.sample(username_for, long_username)))
driver.find_element(By.XPATH, '//*[@id="password-input"]').send_keys("CloudKid123!Assxdr")
driver.find_element(By.XPATH, '//*[@id="password-input-confirmation"]').send_keys("CloudKid123!Assxdr")
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[4]/div/div[2]/div[1]/select').click()
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[4]/div/div[2]/div[1]/select/option[5]').click()
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[4]/div/div[2]/div[2]/div/input').send_keys("18")
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[4]/div/div[2]/div[3]/div/input').send_keys("1999")
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[5]/div/div[2]/button/div/div[2]').click()
driver.find_element(By.XPATH, '//*[@id="email-input"]').send_keys(emailrepl)
time.sleep(3)
driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[3]/div/div/div/div[3]/form/div/div[6]/button').click()
